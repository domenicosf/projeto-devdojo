...
public class BaseSwaggerConfig {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                ...
                .version("1.0")
                .contact(new Contact("Domenico Schettini Filho as the Jedi Master", "http://devdojo.academy", "domenicosf07@gmail.com"))
                .license("Private stuff bro, belongs to Domenico Schettini Filho")
