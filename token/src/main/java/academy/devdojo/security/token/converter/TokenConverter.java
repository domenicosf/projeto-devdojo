...
public class TokenConverter {
    ...
    public void validateTokenSignature(String signedToken){
        ...
        log.info("Token parsed! Retrieving public key form signed token");
        ...
        if(!signedJWT.verify(new RSASSAVerifier(publicKey)))
            throw new org.springframework.security.access.AccessDeniedException("Inmvalid token signature");
